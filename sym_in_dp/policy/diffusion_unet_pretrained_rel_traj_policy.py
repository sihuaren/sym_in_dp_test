...
from sym_in_dp.model.vision.timm_obs_encoder import TimmObsEncoder, C8EquivariantTimmObsEncoder   
...
class DiffusionUnetPretrainedRelTrajPolicy(BaseImagePolicy):
    def __init__(self, 
            shape_meta: dict,
        ...
        if obs_as_global_cond:
            ...
            if type(obs_encoder) in [C8EquivariantTimmObsEncoder, TimmObsEncoder]:
    ...
    def predict_action(self, obs_dict: Dict[str, torch.Tensor]) -> Dict[str, torch.Tensor]:
        ...
        if self.obs_as_global_cond:
            ...
            if type(self.obs_encoder) not in [TimmObsEncoder, C8EquivariantTimmObsEncoder]:
